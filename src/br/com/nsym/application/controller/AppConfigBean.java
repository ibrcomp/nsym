...
import br.com.nsym.domain.model.service.ConfigurationService;
...
public class AppConfigBean implements Serializable {
    ...
    protected void initialize(@Observes LoggedInEvent event) {
        ...
        this.configuration = this.configurationService.loadDefault(user.getConfig().getId());
    ...
    protected void remove(@Observes AlreadyLoggedInEvent event){
