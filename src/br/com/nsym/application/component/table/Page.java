...
public class Page<T extends IPersistentEntity<?>> {
    ...
    public Optional<TotalizadorFinanceiro> optionalTotalizador;
     ...
     * @param totalPages 
     */
    public Page(List<T> content, Long totalPages,TotalizadorFinanceiro totais) {
        this.optionalContent = Optional.of(content);
        this.optionalTotalPages = Optional.of(totalPages);
        this.optionalTotalizador = Optional.of(totais);
    }
     ...
     * @return 
     */
    public TotalizadorFinanceiro getTotais() {
        return this.optionalTotalizador.orElse(new TotalizadorFinanceiro());
    }
     ...
     * @param totais
     */
    public void setTotais(TotalizadorFinanceiro totais) {
         this.optionalTotalizador = Optional.of(totais);
    }
    /**
     * 
