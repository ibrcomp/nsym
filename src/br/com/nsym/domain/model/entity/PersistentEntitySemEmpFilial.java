...
@EntityListeners(PersistentEntityListenerEmpFilial.class)
public abstract class PersistentEntitySemEmpFilial implements IPersistentEntity<Long>, Serializable {
