 ...
 * basicos para que a classe possa ser persistente. exclusivo Controle de logon
 *
 * @author Ibrahim Yousef Quatani
 *
 * @version 2.0.0
 * @since 1.0.0, 30/08/2017
 */
@MappedSuperclass
@ToString(of = "id")
@EqualsAndHashCode(of = "id")
@EntityListeners(PersistentEntityListenerLogon.class)
public abstract class PersistentEntityLogon implements IPersistentEntity<Long>, Serializable {
