...
//					Restrictions.isNull("idFilial"),
    ...
    /**
     *  	M�tdodo que retorna uma lista, caso queira que o retorno contenha as informa�oes empresa e filial informe global = true
     ...
     * @param deleted (TRUE- exibe somente Excluidos  FALSE - Exibe os n�o excluidos)
     * @return Lista<T>
     */
